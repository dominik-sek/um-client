            ...
            <div className={'flex flex-col items-center gap-y-5'}>
              <form className={'flex flex-col w-full items-center gap-y-8 w-3/4'} onSubmit={handleSubmit}>
                <div className='relative w-full'>
                  ...
                  />
                  <p
                    className={clsx('absolute text-xs pt-1 pb-1 text-red-light opacity-0 duration-200', isValidationError && '!opacity-100')}>Invalid
                ...
                <div className={'flex w-full justify-between'}>
                  <LinkButton textColorClass={'!text-blue-light'} url={'/'} className={'text-sm w-fit'}> Contact with an
                    administrator </LinkButton>
                  <LinkButton textColorClass={'!text-red-light'} url={'/'} className={'text-sm w-fit'}> Forgot
                    Password? </LinkButton>
                </div>
