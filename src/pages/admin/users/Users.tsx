...
const LazyUserCard = React.lazy(
	() => import('../../../components/shared/user-card'),
);
			...
			<Box
				...
				<Flex
					...
					<SearchBar
						...
						searchPlaceholder={t('searchUsers') as string}
					/>
					...
					{isLargerThanMedium ? (
						...
						<VStack
							...
							<IconButton
								icon={<FaUpload />}
								aria-label={'upload file to add multiple users'}
								id={'add-multiple-btn'}
								colorScheme={'telegram'}
								width={'100%'}
								onClick={onMultipleOpen}
