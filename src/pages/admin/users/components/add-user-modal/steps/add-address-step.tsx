...
export const AddAddressStep = (props: {
		...
		<form style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
			...
			<FormControl isRequired isInvalid={!!errors?.city?.message}>
				...
				<Input
					...
					onChange={(e) => handleFormValuesChange(e, 'city')}
					required
			...
			<FormControl isRequired isInvalid={!!errors?.state?.message}>
				...
				<Input
					...
					onChange={(e) => handleFormValuesChange(e, 'state')}
					required
			...
			<FormControl isRequired isInvalid={!!errors?.country?.message}>
				...
				<Input
					...
					onChange={(e) => handleFormValuesChange(e, 'country')}
					required
					placeholder="PL"
					type={'text'}
				/>
			...
			<FormControl isRequired isInvalid={!!errors?.postal_code?.message}>
				...
				<Input
					...
					onChange={(e) => handleFormValuesChange(e, 'postal_code')}
					required
					placeholder="00-000"
					type={'text'}
				/>
			...
			<FormControl isRequired isInvalid={!!errors?.street?.message}>
				...
				<Input
					...
					onChange={(e) => handleFormValuesChange(e, 'street')}
					required
					placeholder={t('street') as string}
					type={'text'}
				/>
				<FormErrorMessage>
			...
			<FormControl isRequired isInvalid={!!errors?.email?.message}>
				...
				<Input
					...
					onChange={(e) => handleFormValuesChange(e, 'email')}
					required
					placeholder="Email"
					type={'email'}
				/>
			...
			<FormControl isRequired isInvalid={!!errors?.phone_number?.message}>
				...
				<Input
					...
					onChange={(e) => handleFormValuesChange(e, 'phone_number')}
					required
