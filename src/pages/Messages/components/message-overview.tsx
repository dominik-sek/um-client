...
export const MessageOverview = (props: MessageOverviewProps) => {
    ...
    return (
        <Tab onClick={props.onClick} onLoad={props.onLoad} value={props.chatroom.id} p={'6'} gap={'2'} w={'100%'} alignItems={'center'} bgColor={'gray.800'} rounded={'md'} cursor={'pointer'} _hover={{bgColor:'gray.700'}}>
