import React, { ForwardedRef, LegacyRef, ReactElement } from 'react';
  ...
  return(
    <div className={clsx('', props.className)}>
      <input onChange={props.onChange}
             ...
             ref={ref}
             className={clsx(
               'block px-2.5  pb-2.5 pt-4 w-full text-sm  border border-gray-light/20 text-gray-900 bg-transparent\n' +
      ...
      <label htmlFor={props.name}
             className={clsx('absolute text-sm bg-gray-medium text-gray-light duration-300 transform -translate-y-4 scale-75 \n' +
